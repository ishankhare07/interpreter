...
import (
	"fmt"
	"gitlab.com/ishankhare07/monkey-lang/ast"
	"gitlab.com/ishankhare07/monkey-lang/lexer"
	"testing"
)
...
func TestFunctionLiteralParsing(t *testing.T) {
	...
	t.Log("testing literal expression")
	testLiteralExpression(t, function.Parameters[0], "x")
	testLiteralExpression(t, function.Parameters[1], "y")

	if len(function.Body.Statements) != 1 {
		t.Fatalf("function body does not has 1 statement. got=%d", len(function.Body.Statements))
	}
	...
	t.Log("Testing infix expression")
